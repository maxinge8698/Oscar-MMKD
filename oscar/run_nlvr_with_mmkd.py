...
def train(args, train_dataset, eval_dataset, student_model, teacher_model, tokenizer):
    ...
    for epoch in train_iterator:
        ...
        if (args.local_rank in [-1, 0]) and (args.save_epoch > 0 and epoch % args.save_epoch == 0) and (epoch > args.save_after_epoch):
            # base_output_dir = os.path.join(args.output_dir, 'checkpoint-{}'.format(epoch + 1))  # ./model/nlvr2/student/checkpoint-1
            # teacher_output_dir = os.path.join(base_output_dir, 'teacher')  # ./model/nlvr2/student/checkpoint-1/teacher
            # student_output_dir = os.path.join(base_output_dir, 'student')  # ./model/nlvr2/student/checkpoint-1/student
